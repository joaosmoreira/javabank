...
public class BankApplication {
     ...
     */
    public BankApplication(Bank bank) { //Put in View
        this.bank = bank;
     ...
     */
    public void start() {// Put in Controller - main controller

        mainMenu = buildMainMenu(); // main

        accessingCustomerId = scanCustomerId(); // log
        operationsMap = buildOperationsMap(); //Account
        menuLoop();
    }

    private void menuLoop() {  // Put in controller - main controller
    ...
    /*private int scanCustomerId() { // Put in View - log in view
    ...
    private MenuInputScanner buildMainMenu() {// Put in View - menu view
    ...
    private Map<Integer, Operation> buildOperationsMap() {// Put in View

        Map<Integer, Operation> map = new HashMap<>();
        map.put(UserOptions.GET_BALANCE.getOption(), new BalanceOperation(this)); //Put in balance view
        map.put(UserOptions.DEPOSIT.getOption(), new DepositOperation(this));//Put in deposit view
        map.put(UserOptions.WITHDRAW.getOption(), new WithdrawOperation(this));//Put in withdraw view
        map.put(UserOptions.OPEN_ACCOUNT.getOption(), new NewAccountOperation(this));// Put in account view
